...
<table border =1 style = "color:white;">
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		echo"<tr>".
                           	"<td>".$row["userid"]."</td>".
		"<td>".$row["review"]."</td>".
	                '<td><a href = "like12.php? x='.$row["Sr_no"].'"><i class="fa fa-thumbs-up" style="font-size:36px;color:white"></i></a></td>'."</tr>";
	}
	}
	else
	{
...
<br><br>
<button class="button" onclick="goBack()">Back</button></body></body>
</html>