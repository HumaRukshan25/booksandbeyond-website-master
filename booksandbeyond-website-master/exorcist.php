...
function write_review(f1)
{
		...
		if($rev!=NULL)
		{
			...
			if(mysqli_query($conn,$query))
			{
				...
				header('Location: readreview4.php');  
			}
		}
		else
		{
...
<h1> <center>THE EXORCIST </center></h1>
<h2> <center>WILLIAM PETER BLATTY </center></h2>
<p>

<img class="displayed" src="exorcist.jpeg" style=width:"10px" height:"10px";> 
...
<b>Original Title:</b>The Exorcist<br>
<b>ISBN:</b>0061007226 (ISBN13: 9780061007224)<br>
<b>Edition Language:</b>English<br>
<b>Series:</b>The Exorcist<br>
<b>Characters:</b>Lankester Merrin, Pazuzu, Damien Karras, Regan MacNeil, Chris MacNeil<br>
<b>Literary Awards:</b>California Book Award Gold Medal Nominee for Fiction (1971), Audie Award for Narration by the Author or Authors (2000)<br><br>

<b><font color=yellow>DOWNLOAD THE FREE PDF HERE!</font><b> <br>
<a href="exorcist.pdf">The Exorcist-William Peter Blatty.pdf</a> <br> <br>
...
<!-- <input type="button" value="Write Review"> -->
 <input type="button" class="button" onclick="location.href = 'readreview4.php';" value="Read  Review">
<BR><BR>
