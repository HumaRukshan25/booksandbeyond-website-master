<html>
 <head>
 <title>A FACE IN THE DARK AND OTHER HAUNTINGS</title>
<script>
function write_review(f1)
{
		...
		if($rev!=NULL)
		{
			...
			if(mysqli_query($conn,$query))
			{
				...
				header('Location: readreview6.php');  
			}
		}
...
<h1> <center>A FACE IN THE DARK AND OTHER HAUNTINGS</center></h1>
<h2> <center> RUSKIN BOND</center></h2>
<p>

<img class="displayed" src="face.jpg" style=width:"10px" height:"10px";> 
...
A Face in the Dark and Other Hauntings is the perfect collection to have by your bedside when the moon is up. <br> <br>

<b><font color=yellow>BOOK DETAILS:</font></b><br>
<b>Original Title:</b>A Face in the Dark and Other Hauntings: Collected Stories of the Supernatural <br>
<b>ISBN:</b> 0670057983 (ISBN13: 9780670057986) <br>
...
<!-- <input type="button" value="Write Review"> -->
 <input type="button" class="button" onclick="location.href = 'readreview6.php';" value="Read  Review">
<BR><BR>
