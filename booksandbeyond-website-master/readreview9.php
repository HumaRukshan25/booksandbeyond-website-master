<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css"><html><head><script>
function goBack() {
    window.history.back();
}
...
<table border =1 style = "color:white;">
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		echo"<tr>".
                           	"<td>".$row["userid"]."</td>".
		"<td>".$row["review"]."</td>".
	                '<td><a href = "like9.php? x='.$row["Sr_no"].'"><i class="fa fa-thumbs-up" style="font-size:36px;color:white"></i></a></td>'."</tr>";
	}
	}
	else
	{
